    ...
    getNotification=()=>{
        ...
        .onSnapshot(snapshot=>{
          ...
          snapshot.docs.map(doc=>{
            ...
            all_notification.push(notification);
          });
      ...
      renderItem = ( {item, i} ) =>(
        <ListItem
          key={i}
          title={item.itemName}
          subtitle={"Barted By " + item.donor_id +"\nBarter Status : " + item.Message}
      ...
      render(){
        return(
          <View style={styles.container}>
            ...
            <View style={{flex:0.9}}>
            {
            this.state.all_notification.length === 0
            ?(
            ...
            :(
              <SwipeableFlatlist allNotifications={this.state.all_notification}/>
            )
          }
            </View>
          </View>
